...
<body>
	...
	<header id="main-header" class="bg-primary py-2 text-white">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<h1><i class="fa fa-user"></i>Student Registration</h1>
				</div>
			</div>
		</div>
	</header>
...
<?php 
	...
	if(isset($_POST['submit'])){
		...
		$check_email_sql = "SELECT * FROM student WHERE email = '$user'";
		...
		if($check_email > 0){
			...
			$insert_sql = "INSERT INTO student (id, name, class, email, password) VALUES ('$id', '$name', '$class', '$user', '$password')";
