...
<body>
	...
	<header id="main-header" class="bg-danger py-2 text-white">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<h1><i class="fa fa-user-secret"></i>Faculty Login</h1>
				</div>
			</div>
		</div>
	</header>
				...
				<div class="col-md-6 offset-md-3">
					<div class="card">
						...
						<div class="card-body p-3">
							...
							<br>
							<a href=/SLMS/admin/register.php>New? Register Here</a>
						</div>
					</div>
				</div>
			</div>
...
<?php 
	...
	if(isset($_POST['submit'])){
		...
		$sql = "SELECT * FROM faculty WHERE email = '$user' AND password = '$password'";
