	...
	<section id="sections" class="py-4 mb-4 bg-faded">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3">
					<a href="#" class="btn btn-warning btn-block" style="border-radius:0%;" data-toggle="modal" data-target="#addCateModal"><i class="fa fa-spinner"></i> Pendings Leaves</a>
				</div>
				<div class="col-md-3">
					...
					<form action="" method="post">
						<div class="form-group">
							...
							<select name="class" class="form-control">
								...
								<option value="SY CSBS">S.Y CSBS</option>
								<option value="FY CSBS A">F.Y CSBS A</option>
								<option value="FY CSBS B">F.Y CSBS B</option>
								<option value="FY CSBS C">F.Y CSBS C</option>
						...
						<div class = 'form-group'>
							<label class="form-control-label">Leave Duration</label>
                            <input type="text" name="leavedur" class="form-control" />
                        </div>
						<div class="form-group">
...
<?php 
	if (isset($_POST['apply'])){
		...
		$sql = "INSERT INTO leaves(name,email,class,leavedate,leavedur,leavereason,status) VALUES('$name','$email','$class','$leavedate','$leavedur','$editor1','$status')";
		...
		if($run == true){
			...
			echo "<script> 
			alert('Failed To Apply: ".mysqli_error($con)."');
			</script>";
		}
	}
